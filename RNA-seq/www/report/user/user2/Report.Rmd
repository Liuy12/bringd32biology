...
```{r echo=FALSE, warning=FALSE,cache=FALSE,results='asis'}
cat('<iframe src="htmlFiles/DEheatmap.html" width=1000px height=1000px allowtransparency="true"> </iframe>')
```
...
```{r echo=FALSE, warning=FALSE,cache=FALSE,results='asis'}
cat('<iframe src="htmlFiles/DispersionPlot.html" width=1000px height=1000px allowtransparency="true"> </iframe>')
```
